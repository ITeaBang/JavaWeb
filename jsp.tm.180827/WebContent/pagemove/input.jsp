...
<body>
	<a href="process.jsp?email=ITeaBang@gmail.com&pw=1234">process로 이동</a><br />
...
<script>
	...
	ajax.addEventListener("click", function(e) {
		...
		// 요청을 생성하고 요청
		// request.open('GET', 'process.jsp?email=ITeaBang');
		
		// ajax에서 POST 방식으로 파라미터 전송
		request.open('POST', 'process.jsp')
		// 전송방식을 form으로 설정해서 post 방식으로 전송
		request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		request.send('email=ITeaBang@gmail.com');
